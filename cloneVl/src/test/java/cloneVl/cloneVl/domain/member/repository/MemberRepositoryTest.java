...
class MemberRepositoryTest {
    ...
    public void 성공_회원수정() throws Exception {
        //given
        Member member1 = Member.builder().username("username").password("1234567890").name("Member1").role(Role.USER).nickName("NickName1").age(22).intro("안녕하세여!").build();
        memberRepository.save(member1);
        clear();
        ...
        findMember.updateIntro(updateIntro);
        em.flush();
        ...
        assertThat(findUpdateMember.getIntro()).isEqualTo(updateIntro);
    }
